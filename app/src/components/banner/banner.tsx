   ...
   const data = [
      {
         ...
         backgroud:'#F9F0EE',
         title:'PRODUTOS',
         cardContent:'Vidrálias e Equipamentos',
         contentImg:
      ...
      }, 
      {
         ...
         backgroud:'#F9F0EE',
         title:'LABORATÓRIO',
         cardContent:'Ferramentas e utensílios'         
      }, 
   ]
   return(
      <>
         ...
         {
            data.map((e)=> {
               const { id, backgroud, title,cardContent, contentImg} = e
               
               return(
                  <Cards key={ id } backGround={ backgroud } title={ title} cardContent={cardContent} contentImg={contentImg}/>
                  )
            })
         }
         </div>
